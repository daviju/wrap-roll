<header>
        <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #e1d8b8;">

            <img src="./images/Wrap&Roll.png" alt="Logo Kebab" width="100px" height="100px">

            <a class="navbar-brand" href="#">Wrap 'n' Roll</a>
